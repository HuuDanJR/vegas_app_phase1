...
class _HomePageState extends State<HomePage> {
    ...
    AndroidNotificationDetails androidNotificationDetails =
      ...
      actions: <AndroidNotificationAction>[
        AndroidNotificationAction(
          urlLaunchActionId,
          'Action 1',
          icon: const DrawableResourceAndroidBitmap('food'),
          contextual: true,
        ),
        ...
        AndroidNotificationAction(
          navigationActionId,
          'Action 3',
          icon: const DrawableResourceAndroidBitmap('secondary_icon'),
  ...
  Future<void> _showNotificationWithNoSound() async {
    AndroidNotificationDetails androidNotificationDetails =
        const AndroidNotificationDetails('silent channel id', 'silent channel name',
  ...
  Future<void> _showMessagingNotification() async {
    ...
    /// drawable resources
    Person me = const Person(
      name: 'Me',
      key: '1',
      uri: 'tel:1234567890',
      icon: DrawableResourceAndroidIcon('me'),
    );
    Person coworker = const Person(
      name: 'Coworker',
      key: '2',
      uri: 'tel:9876543210',
  ...
  Future<void> _showNotificationWithNoBadge() async {
    AndroidNotificationDetails androidNotificationDetails =
        const AndroidNotificationDetails('no badge channel', 'no badge name',
  ...
  Future<void> _showNotificationWithSubtitle() async {
    DarwinNotificationDetails darwinNotificationDetails =
        const DarwinNotificationDetails(subtitle: 'the subtitle');
    NotificationDetails notificationDetails = NotificationDetails(
  ...
  Future<void> _createNotificationChannelGroup() async {
    String channelGroupId = 'your channel group id';
  ...
  Future<void> _deleteNotificationChannelGroup() async {
    ...
    await showDialog<void>(
      context: context,
      builder: (BuildContext context) => AlertDialog(
        content: Text('Channel group with id $channelGroupId deleted'),
        actions: <Widget>[
          TextButton(
            onPressed: () {
              Navigator.of(context).pop();
  ...
  Future<void> _deleteNotificationChannel() async {
    String channelId = 'your channel id 2';
    await flutterLocalNotificationsPlugin
        .resolvePlatformSpecificImplementation<
            AndroidFlutterLocalNotificationsPlugin>()
...
Future<void> _showLinuxNotificationDifferentLocation() async {
  LinuxNotificationDetails linuxPlatformChannelSpecifics =
      const LinuxNotificationDetails(location: LinuxNotificationLocation(10, 10));
  NotificationDetails notificationDetails = NotificationDetails(
    linux: linuxPlatformChannelSpecifics,
  );
  await flutterLocalNotificationsPlugin.show(
